      ...
      <div className="nav-head">
        <MDBContainer fluid>
          <MDBRow className="boxnav">
            <MDBCol size="1" className=" h-100 bars d-flex align-items-center ">
              <FaBars onClick={(closSide) => setSide(!side)} />
            </MDBCol>
            <MDBCol
              size="11"
              md="9"
              className=" d-flex justify-content-center  align-items-center  logo h-100 "
            >
              <img src={logokpru} width="30px" /> &nbsp; ระบบตรวจสอบครุภัณฑ์
              สำนักส่งเสริมวิชาการและงานทะเบียน
            </MDBCol>
            <MDBCol className="   name-d h-100 mx-3">
              <div className="name">ชื่อผู้ใช้</div>
              <IoMdArrowDropdown
                onClick={dropdown}
                className={dd ? "up active " : "up"}
              />
            </MDBCol>
          </MDBRow>
        </MDBContainer>
